...
Shader "Hidden/VacuumShaders/The Amazing Wireframe/Mobile/One Directional Light/Multiply/ZWrite/Wire Only"
{
    Properties 
    {
		//Tag 
    ...
    SubShader  
    {
		...
		UsePass "Hidden/VacuumShaders/The Amazing Wireframe/Mobile/One Directional Light/Multiply/Simple/Wire Only/BASE"
