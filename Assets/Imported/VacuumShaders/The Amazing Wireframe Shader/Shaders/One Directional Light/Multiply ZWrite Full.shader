...
Shader "Hidden/VacuumShaders/The Amazing Wireframe/Mobile/One Directional Light/Multiply/ZWrite/Full"
{
    Properties 
    {
		//Tag 
    ...
    SubShader  
    {
		...
		UsePass "Hidden/VacuumShaders/The Amazing Wireframe/Mobile/One Directional Light/Multiply/Simple/Full/BASE"
