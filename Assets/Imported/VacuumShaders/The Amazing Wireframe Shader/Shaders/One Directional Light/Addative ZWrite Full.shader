...
Shader "Hidden/VacuumShaders/The Amazing Wireframe/Mobile/One Directional Light/Addative/ZWrite/Full"
{
    Properties 
    {
		//Tag 
    ...
    SubShader  
    {
		...
		UsePass "Hidden/VacuumShaders/The Amazing Wireframe/Mobile/One Directional Light/Addative/Simple/Full/BASE"
