...
Shader "Hidden/VacuumShaders/The Amazing Wireframe/Mobile/One Directional Light/Addative/ZWrite/Wire Only"
{
    Properties 
    {
		//Tag 
    ...
    SubShader  
    {
		...
		UsePass "Hidden/VacuumShaders/The Amazing Wireframe/Mobile/One Directional Light/Addative/Simple/Wire Only/BASE"
