...
Shader "Hidden/VacuumShaders/The Amazing Wireframe/Geometry Shader/Addative/ZWrite/Full"
{
    Properties 
    {
		//Tag         
    ...
    SubShader   
    {
		...
		UsePass "Hidden/VacuumShaders/The Amazing Wireframe/Geometry Shader/Addative/Simple/Full/BASE"
