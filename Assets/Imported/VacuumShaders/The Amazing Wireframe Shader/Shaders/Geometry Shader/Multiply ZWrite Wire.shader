...
Shader "Hidden/VacuumShaders/The Amazing Wireframe/Geometry Shader/Multiply/ZWrite/Wire Only"
{
    Properties 
    {
		//Tag         
    ...
    SubShader  
    {
		...
		UsePass "Hidden/VacuumShaders/The Amazing Wireframe/Geometry Shader/Multiply/Simple/Wire Only/BASE"
