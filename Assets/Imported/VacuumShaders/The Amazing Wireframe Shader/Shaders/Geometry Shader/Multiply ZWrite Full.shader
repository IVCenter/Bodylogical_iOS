...
Shader "Hidden/VacuumShaders/The Amazing Wireframe/Geometry Shader/Multiply/ZWrite/Full"
{
    Properties 
    {
		//Tag         
    ...
    SubShader   
    {
		...
		UsePass "Hidden/VacuumShaders/The Amazing Wireframe/Geometry Shader/Multiply/Simple/Full/BASE"
