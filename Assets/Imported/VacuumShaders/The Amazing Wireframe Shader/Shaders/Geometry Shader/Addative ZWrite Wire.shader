...
Shader "Hidden/VacuumShaders/The Amazing Wireframe/Geometry Shader/Addative/ZWrite/Wire Only"
{
    Properties 
    {
		//Tag         
    ...
    SubShader  
    {
		...
		UsePass "Hidden/VacuumShaders/The Amazing Wireframe/Geometry Shader/Addative/Simple/Wire Only/BASE"
