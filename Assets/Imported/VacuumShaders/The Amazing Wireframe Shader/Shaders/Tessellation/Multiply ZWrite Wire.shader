...
Shader "Hidden/VacuumShaders/The Amazing Wireframe/Tessellation/Multiply/ZWrite/Wire Only"
{
    Properties 
    {
		//Tag         
    ...
    SubShader  
    {
		...
		UsePass "Hidden/VacuumShaders/The Amazing Wireframe/Tessellation/Multiply/Simple/Wire Only/BASE"
