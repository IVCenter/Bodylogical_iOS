...
Shader "Hidden/VacuumShaders/The Amazing Wireframe/Tessellation/Addative/ZWrite/Full"
{
    Properties 
    {
		//Tag         
    ...
    SubShader   
    {
		...
		UsePass "Hidden/VacuumShaders/The Amazing Wireframe/Tessellation/Addative/Simple/Full/BASE"
